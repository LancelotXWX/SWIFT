...
from models import Informer, Autoformer, Transformer, DLinear, Linear, PatchTST, SWIFT_Linear, SWIFT_MLP
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        if any(substr in self.args.model for substr in {'Linear', 'TST', 'SparseTSF', 'SWIFT', 'SWIFT_Linear', 'SWIFT_MLP'}):
